...
const customerGroups_service_1 = require("./customerGroups.service");
const dto_1 = require("./dto");
const entities_1 = require("./entities");
let CustomerGroupsController = exports.CustomerGroupsController = class CustomerGroupsController {
    ...
    async updateById(id, dto, req) {
        ...
        try {
            const userId = '';
            console.log(id);
            const record = await this.customerGroupsService.updateById(id, dto, userId);
            dataOut.data.customerGroups = record;
        }
        catch (error) {
            dataOut.status = false;
...
__decorate([
    (0, common_1.Get)(''),
    (0, swagger_1.ApiCreatedResponse)({ type: entities_1.CustomerGroupEntity, isArray: true }),
    openapi.ApiResponse({ status: 200 }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], CustomerGroupsController.prototype, "getAll", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], CustomerGroupsController.prototype, "getAllDeleted", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiCreatedResponse)({ type: entities_1.CustomerGroupEntity }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CustomerGroupsController.prototype, "getById", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CustomerGroupsController.prototype, "searchFirst", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CustomerGroupsController.prototype, "searchMany", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CustomerGroupsController.prototype, "searchFirstDeleted", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CustomerGroupsController.prototype, "searchManyDeleted", null);
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiCreatedResponse)({ type: entities_1.CustomerGroupEntity }),
    openapi.ApiResponse({ status: 201 }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.CreateCustomerGroupDto, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.UpdateCustomerGroupDto, Object]),
    __metadata("design:returntype", Promise)
], CustomerGroupsController.prototype, "updateById", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CustomerGroupsController.prototype, "deleteById", null);
exports.CustomerGroupsController = CustomerGroupsController = __decorate([
    (0, swagger_1.ApiTags)('Customer Groups'),
    (0, common_1.Controller)('api/customer-groups'),
    __metadata("design:paramtypes", [customerGroups_service_1.CustomerGroupsService])
