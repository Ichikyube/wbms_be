...
const customerTypes_service_1 = require("./customerTypes.service");
const dto_1 = require("./dto");
const entities_1 = require("./entities");
let CustomerTypesController = exports.CustomerTypesController = class CustomerTypesController {
    constructor(customerTypesService) {
    ...
    async updateById(id, dto, req) {
        ...
        try {
            const userId = '';
            console.log(id);
            const record = await this.customerTypesService.updateById(id, dto, userId);
            dataOut.data.customerType = record;
        }
        catch (error) {
            dataOut.status = false;
...
__decorate([
    (0, common_1.Get)(''),
    (0, swagger_1.ApiCreatedResponse)({ type: entities_1.CustomerTypeEntity, isArray: true }),
    openapi.ApiResponse({ status: 200 }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], CustomerTypesController.prototype, "getAll", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], CustomerTypesController.prototype, "getAllDeleted", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiCreatedResponse)({ type: entities_1.CustomerTypeEntity }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CustomerTypesController.prototype, "getById", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CustomerTypesController.prototype, "searchFirst", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CustomerTypesController.prototype, "searchMany", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CustomerTypesController.prototype, "searchFirstDeleted", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CustomerTypesController.prototype, "searchManyDeleted", null);
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiCreatedResponse)({ type: entities_1.CustomerTypeEntity }),
    openapi.ApiResponse({ status: 201 }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.CreateCustomerTypeDto, Object]),
    __metadata("design:returntype", Promise)
], CustomerTypesController.prototype, "create", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiCreatedResponse)({ type: entities_1.CustomerTypeEntity }),
    openapi.ApiResponse({ status: 200 }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.UpdateCustomerTypeDto, Object]),
    __metadata("design:returntype", Promise)
], CustomerTypesController.prototype, "updateById", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CustomerTypesController.prototype, "deleteById", null);
exports.CustomerTypesController = CustomerTypesController = __decorate([
    (0, swagger_1.ApiTags)('Customer Types'),
    (0, common_1.Controller)('api/customer-types'),
    __metadata("design:paramtypes", [customerTypes_service_1.CustomerTypesService])
