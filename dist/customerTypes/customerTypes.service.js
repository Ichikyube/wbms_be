...
exports.CustomerTypesService = void 0;
const common_1 = require("@nestjs/common");
const db_service_1 = require("../db/db.service");
let CustomerTypesService = exports.CustomerTypesService = class CustomerTypesService {
    constructor(db) {
        this.db = db;
    }
    async getAll() {
...
exports.CustomerTypesService = CustomerTypesService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [db_service_1.DbService])
], CustomerTypesService);
//# sourceMappingURL=customerTypes.service.js.map