...
exports.ProductGroupsService = void 0;
const common_1 = require("@nestjs/common");
const db_service_1 = require("../db/db.service");
let ProductGroupsService = exports.ProductGroupsService = class ProductGroupsService {
    constructor(db) {
        this.db = db;
    }
    async getAll() {
...
exports.ProductGroupsService = ProductGroupsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [db_service_1.DbService])
], ProductGroupsService);
//# sourceMappingURL=productGroups.service.js.map