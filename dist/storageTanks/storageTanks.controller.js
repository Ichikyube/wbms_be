...
exports.StorageTanksController = void 0;
const openapi = require("@nestjs/swagger");
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const storageTanks_service_1 = require("./storageTanks.service");
const dto_1 = require("./dto");
const entities_1 = require("./entities");
let StorageTanksController = exports.StorageTanksController = class StorageTanksController {
    constructor(storageTanksService) {
...
__decorate([
    (0, common_1.Get)(''),
    (0, swagger_1.ApiCreatedResponse)({ type: entities_1.StorageTankEntity, isArray: true }),
    openapi.ApiResponse({ status: 200 }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], StorageTanksController.prototype, "getAll", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], StorageTanksController.prototype, "getAllDeleted", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiCreatedResponse)({ type: entities_1.StorageTankEntity }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], StorageTanksController.prototype, "getById", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], StorageTanksController.prototype, "searchFirst", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], StorageTanksController.prototype, "searchMany", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], StorageTanksController.prototype, "searchFirstDeleted", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], StorageTanksController.prototype, "searchManyDeleted", null);
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiCreatedResponse)({ type: entities_1.StorageTankEntity }),
    openapi.ApiResponse({ status: 201 }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.CreateStorageTankDto, Object]),
    __metadata("design:returntype", Promise)
], StorageTanksController.prototype, "create", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiCreatedResponse)({ type: entities_1.StorageTankEntity }),
    openapi.ApiResponse({ status: 200 }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.UpdateStorageTankDto, Object]),
    __metadata("design:returntype", Promise)
], StorageTanksController.prototype, "updateById", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], StorageTanksController.prototype, "deleteById", null);
exports.StorageTanksController = StorageTanksController = __decorate([
    (0, swagger_1.ApiTags)('Storage Tanks'),
    (0, common_1.Controller)('api/storage-tanks'),
    __metadata("design:paramtypes", [storageTanks_service_1.StorageTanksService])
], StorageTanksController);
//# sourceMappingURL=storageTanks.controller.js.map