...
exports.StorageTanksService = void 0;
const common_1 = require("@nestjs/common");
const db_service_1 = require("../db/db.service");
let StorageTanksService = exports.StorageTanksService = class StorageTanksService {
    constructor(db) {
        this.db = db;
    }
    async getAll() {
...
exports.StorageTanksService = StorageTanksService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [db_service_1.DbService])
], StorageTanksService);
//# sourceMappingURL=storageTanks.service.js.map