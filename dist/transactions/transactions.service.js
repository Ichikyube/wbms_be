...
let TransactionService = exports.TransactionService = class TransactionService {
    ...
    async openCreateByQrcodeSemai(body) {
        ...
        try {
            ...
            try {
                dataOut.data.tType =
                    statusMapping[tType][decodedQrcode.vehicleOperationStatus][decodedQrcode.deliveryStatus];
                dataOut.data.urlPath =
                    urlMapping[tType][decodedQrcode.vehicleOperationStatus][decodedQrcode.deliveryStatus];
            }
            catch (error) {
    ...
    copyQrToTransaction(dto, tType) {
        ...
        transaction.deliveryDate = dto.deliveryDate
            ? moment(dto === null || dto === void 0 ? void 0 : dto.deliveryDate).toDate()
            : null;
