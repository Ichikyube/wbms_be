...
exports.TransportVehicleService = void 0;
const common_1 = require("@nestjs/common");
const db_service_1 = require("../db/db.service");
let TransportVehicleService = exports.TransportVehicleService = class TransportVehicleService {
    constructor(db) {
        this.db = db;
    }
    async getAll() {
...
exports.TransportVehicleService = TransportVehicleService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [db_service_1.DbService])
], TransportVehicleService);
//# sourceMappingURL=transport-vehicle.service.js.map