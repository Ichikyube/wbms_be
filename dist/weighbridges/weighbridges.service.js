...
exports.WeighbridgesService = void 0;
const common_1 = require("@nestjs/common");
const db_service_1 = require("../db/db.service");
let WeighbridgesService = exports.WeighbridgesService = class WeighbridgesService {
    constructor(db) {
        this.db = db;
    }
    async getAll() {
...
exports.WeighbridgesService = WeighbridgesService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [db_service_1.DbService])
], WeighbridgesService);
//# sourceMappingURL=weighbridges.service.js.map